...
export const contentTranslations = {
  pt: {
    ...
    githubLive: {
      ...
      tabContributions: 'Gráfico de Contribuições',
      contributionsTitle: 'Histórico Anual de Contribuições',
      contributionsSub: 'Mapa de commits e frequência de atividade no GitHub ao longo do último ano.',
      contributionsAlt: 'Gráfico de contribuições do GitHub de Gonçalo Lima (@YvlLima)',
      chartError: 'Não foi possível carregar o gráfico em direto. Visita o perfil oficial no GitHub.',
      syncBtn: 'Sincronizar',
      syncing: 'A atualizar...',
  ...
  en: {
    ...
    githubLive: {
      ...
      tabContributions: 'Contribution Graph',
      contributionsTitle: 'Annual Contribution History',
      contributionsSub: 'Overview of GitHub commit activity and frequency over the past year.',
      contributionsAlt: 'GitHub contributions graph for Gonçalo Lima (@YvlLima)',
      chartError: 'Unable to load live contribution chart. Visit the official GitHub profile.',
      syncBtn: 'Synchronize',
      syncing: 'Updating...',
